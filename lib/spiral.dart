...
class SpiralDrawingScreen extends StatefulWidget {
  @override
  _SpiralDrawingScreenState createState() => _SpiralDrawingScreenState();
}

class _SpiralDrawingScreenState extends State<SpiralDrawingScreen> {
